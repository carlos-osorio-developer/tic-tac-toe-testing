...
describe Board do
  ...
  describe '#create_board' do
    it 'returns the board' do
      expect(board1.create_board).to eql("     -----+-----+-----
     [ #{board1.square[0]} ] [ #{board1.square[1]} ] [ #{board1.square[2]} ]
     [ #{board1.square[3]} ] [ #{board1.square[4]} ] [ #{board1.square[5]} ]
     [ #{board1.square[6]} ] [ #{board1.square[7]} ] [ #{board1.square[8]} ]
     -----+-----+-----")
    end
  end
